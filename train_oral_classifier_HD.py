...
BATCH_SIZE = 32                                 # safe for 4 GB w/ mixed precision
VAL_SPLIT  = 0.2
...
model = models.Sequential([
    ...
    layers.Dropout(0.25),
    layers.Dense(num_classes, activation="softmax", dtype="float32")  # cast back to fp32
])
...
model.save(f"oral_classifier_{NOW}_HD.h5")
print("Model saved.")
